      ...
      <>
        <Col style={{ width: 200 }}>
          ...
          <IconBadge
            ...
            BadgeElement={<Text style={{ color: "black" }}>{this.props.products.find(product => product.id === this.props.product.id) ? this.props.products.find(product => product.id === this.props.product.id).quantity : 0} in basket</Text>}
            IconBadgeStyle={{
              width: 100,
              height: 30,
